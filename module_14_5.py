...
button_regist = KeyboardButton(text='Регистрация')
kb.add(button_count, button_info, button_buy, button_regist)
...
async def set_username(message, state):
    ...
    with sqlite3.connect("not_telegram1.db") as connection:
